...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SIDC_2009_CORE;                                                         
INFILE 'MD_SID_2009_CORE.ASC' FIRSTOBS=3 LRECL = 967;                           
...
INPUT                                                                           
      ...
      @570    HCUP_ED                       N2PF.                               
      @572    HCUP_OS                       N2PF.                               
      @574    HISPANIC_X                    $CHAR1.                             
      @575    HOSPBRTH                      N3PF.                               
      @578    HOSPST                        $CHAR2.                             
      @580    HospitalUnit                  N2PF.                               
      @582    KEY                           15.                                 
      @597    LOS                           N5PF.                               
      @602    LOS_X                         N6PF.                               
      @608    MARITALSTATUSUB04             $CHAR1.                             
      @609    MARITALSTATUS_X               $CHAR1.                             
      @610    MDC                           N2PF.                               
      @612    MDC24                         N2PF.                               
      @614    MDC_NoPOA                     N2PF.                               
      @616    MDNUM1_R                      N9PF.                               
      ...
      @672    PL_CBSA                       N3PF.                               
      @675    PL_MSA1993                    N3PF.                               
      @678    PL_NCHS2006                   N2PF.                               
      @680    PL_RUCA10_2005                N2PF.                               
      @682    PL_RUCA2005                   N4P1F.                              
      @686    PL_RUCA4_2005                 N2PF.                               
      @688    PL_RUCC2003                   N2PF.                               
      @690    PL_UIC2003                    N2PF.                               
      @692    PL_UR_CAT4                    N2PF.                               
      @694    PR1                           $CHAR7.                             
      @701    PR2                           $CHAR7.                             
