...
*  Data Step                  *;                                                
*******************************;                                                
DATA MS_SIDC_2013_CORE;                                                         
INFILE 'MS_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1197;                          
...
INPUT                                                                           
      ...
      @364    DXPOA24                       $CHAR1.                             
      @365    DXPOA25                       $CHAR1.                             
      @366    DX_Admitting                  $CHAR7.                             
      @373    DaysToEvent                   N6PF.                               
      @379    ECODE1                        $CHAR7.                             
      @386    ECODE2                        $CHAR7.                             
      @393    ECODE3                        $CHAR7.                             
      @400    ECODE4                        $CHAR7.                             
      ...
      @465    HCUP_ED                       N2PF.                               
      @467    HCUP_OS                       N2PF.                               
      @469    HISPANIC_X                    $CHAR1.                             
      @470    HOSPBRTH                      N3PF.                               
      @473    HOSPST                        $CHAR2.                             
      @475    HospitalUnit                  N2PF.                               
      @477    KEY                           15.                                 
      @492    LOS                           N5PF.                               
      @497    LOS_X                         N6PF.                               
      @503    MDC                           N2PF.                               
      ...
      @576    PL_CBSA                       N3PF.                               
      @579    PL_NCHS                       N2PF.                               
      @581    PL_RUCA10_2005                N2PF.                               
      @583    PL_RUCA2005                   N4P1F.                              
      @587    PL_RUCA4_2005                 N2PF.                               
      @589    PL_RUCC                       N2PF.                               
      @591    PL_UIC                        N2PF.                               
      @593    PL_UR_CAT4                    N2PF.                               
      @595    PR1                           $CHAR7.                             
      ...
      @973    PSTATE                        $CHAR2.                             
      @975    PSTCO2                        N5PF.                               
      @980    PointOfOriginUB04             $CHAR1.                             
      @981    PointOfOrigin_X               $CHAR1.                             
      @982    RACE                          N2PF.                               
      @984    RACE_X                        $CHAR1.                             
      @985    TOTCHG                        N10PF.                              
      @995    TOTCHG_X                      N15P2F.                             
