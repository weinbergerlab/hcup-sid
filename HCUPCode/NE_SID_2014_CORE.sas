...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SIDC_2014_CORE;                                                         
INFILE 'NE_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 598;                           
...
INPUT                                                                           
      ...
      @164    DXPOA9                        $CHAR1.                             
      @165    DXVER                         N3PF.                               
      @168    DX_Admitting                  $CHAR7.                             
      @175    DaysToEvent                   N6PF.                               
      @181    ECODE1                        $CHAR7.                             
      @188    ECODE2                        $CHAR7.                             
      @195    ECODE3                        $CHAR7.                             
      @202    ECODE4                        $CHAR7.                             
      ...
      @279    LOS                           N5PF.                               
      @284    LOS_X                         N6PF.                               
      @290    MARITALSTATUSUB04             $CHAR1.                             
      @291    MARITALSTATUS_X               $CHAR1.                             
      @292    MDC                           N2PF.                               
      @294    MDC24                         N2PF.                               
      @296    MDC_NoPOA                     N2PF.                               
      @298    MEDINCSTQ                     N2PF.                               
      ...
      @344    PL_UIC                        N2PF.                               
      @346    PL_UR_CAT4                    N2PF.                               
      @348    POA_Disch_Edit1               N2PF.                               
      @350    POA_Disch_Edit2               N2PF.                               
      @352    POA_Hosp_Edit1                N2PF.                               
      @354    POA_Hosp_Edit2                N2PF.                               
      @356    POA_Hosp_Edit3                N2PF.                               
      @358    POA_Hosp_Edit3_Value          N8P2F.                              
      @366    PR1                           $CHAR7.                             
      @373    PR2                           $CHAR7.                             
      @380    PR3                           $CHAR7.                             
      @387    PR4                           $CHAR7.                             
