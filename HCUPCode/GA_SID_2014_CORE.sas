...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SIDC_2014_CORE;                                                         
INFILE 'GA_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 2634;                          
...
INPUT                                                                           
      ...
      @1355   LOS                           N5PF.                               
      @1360   LOS_X                         N6PF.                               
      @1366   MARITALSTATUSUB04             $CHAR1.                             
      @1367   MARITALSTATUS_X               $CHAR1.                             
      @1368   MDC                           N2PF.                               
      @1370   MDC24                         N2PF.                               
      @1372   MDC_NoPOA                     N2PF.                               
      @1374   MDNUM1_R                      N9PF.                               
      ...
      @1465   PL_RUCC                       N2PF.                               
      @1467   PL_UIC                        N2PF.                               
      @1469   PL_UR_CAT4                    N2PF.                               
      @1471   POA_Disch_Edit1               N2PF.                               
      @1473   POA_Disch_Edit2               N2PF.                               
      @1475   POA_Hosp_Edit1                N2PF.                               
      @1477   POA_Hosp_Edit2                N2PF.                               
      @1479   POA_Hosp_Edit3                N2PF.                               
      @1481   POA_Hosp_Edit3_Value          N8P2F.                              
      @1489   PR1                           $CHAR7.                             
      @1496   PR2                           $CHAR7.                             
      @1503   PR3                           $CHAR7.                             
      @1510   PR4                           $CHAR7.                             
      ...
      @2247   PSTCO                         N5PF.                               
      @2252   PSTCO2                        N5PF.                               
      @2257   PointOfOriginUB04             $CHAR1.                             
      @2258   PointOfOrigin_X               $CHAR1.                             
      @2259   PrimLang                      $CHAR3.                             
      @2262   RACE                          N2PF.                               
      @2264   RACE_X                        $CHAR1.                             
      @2265   SERVICELINE                   N2PF.                               
      @2267   TOTCHG                        N10PF.                              
      @2277   TOTCHG_X                      N15P2F.                             
      @2292   TRAN_IN                       N2PF.                               
      @2294   TRAN_OUT                      N2PF.                               
      @2296   VisitLink                     N9PF.                               
      @2305   YEAR                          N4PF.                               
