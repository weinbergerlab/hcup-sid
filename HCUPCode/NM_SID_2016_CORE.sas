...
*  Data Step                  *;                                                
*******************************;                                                
DATA NM_SIDC_2016_CORE;                                                         
INFILE 'NM_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 580;                           
...
INPUT                                                                           
      ...
      @213    I10_DX17                      $CHAR7.                             
      @220    I10_DX18                      $CHAR7.                             
      @227    I10_ECAUSE1                   $CHAR7.                             
      @234    I10_ECAUSE2                   $CHAR7.                             
      @241    I10_ECAUSE3                   $CHAR7.                             
      @248    I10_ECAUSE4                   $CHAR7.                             
      @255    I10_ECAUSE5                   $CHAR7.                             
      @262    I10_ECAUSE6                   $CHAR7.                             
      @269    I10_ECAUSE7                   $CHAR7.                             
      @276    I10_NDX                       N3PF.                               
      @279    I10_NECAUSE                   N2PF.                               
      @281    I10_NPR                       N3PF.                               
      @284    I10_PR1                       $CHAR7.                             
      @291    I10_PR2                       $CHAR7.                             
      @298    I10_PR3                       $CHAR7.                             
      ...
      @409    PL_UIC                        N2PF.                               
      @411    PL_UR_CAT4                    N2PF.                               
      @413    POA_Disch_Edit1               N2PF.                               
      @415    POA_Disch_Edit2               N2PF.                               
      @417    POA_Hosp_Edit1                N2PF.                               
      @419    POA_Hosp_Edit2                N2PF.                               
      @421    POA_Hosp_Edit3                N2PF.                               
      @423    POA_Hosp_Edit3_Value          N8P2F.                              
      @431    PointOfOrigin_X               $CHAR1.                             
      @432    PointOfOriginUB04             $CHAR1.                             
      @433    PRDAY1                        N5PF.                               
      @438    PRDAY2                        N5PF.                               
      @443    PRDAY3                        N5PF.                               
      @448    PRDAY4                        N5PF.                               
