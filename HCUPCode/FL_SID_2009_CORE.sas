...
INFILE 'FL_SID_2009_CORE.ASC' LRECL = 1068;                                     
...
INPUT                                                                           
      ...
      @882    PSTATE                   $CHAR2.                                  
      @884    PSTCO2                   N5PF.                                    
      @889    PointOfOriginUB04        $CHAR1.                                  
      @890    PointOfOrigin_X          $CHAR2.                                  
      @892    RACE                     N2PF.                                    
      @894    RACE_X                   $CHAR1.                                  
      @895    TOTCHG                   N10PF.                                   
      @905    TOTCHG_X                 N15P2F.                                  
