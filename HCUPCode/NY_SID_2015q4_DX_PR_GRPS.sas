...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'NY_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 704;                   
...
INPUT                                                                           
      ...
      @518    I10_PRMCCS1                   $CHAR8.                             
      @526    I10_PRMCCS2                   $CHAR8.                             
      @534    I10_PRMCCS3                   $CHAR8.                             
      @542    I10_PRMCCS4                   $CHAR8.                             
      @550    I10_PRMCCS5                   $CHAR8.                             
      @558    I10_PRMCCS6                   $CHAR8.                             
      @566    I10_PRMCCS7                   $CHAR8.                             
      @574    I10_PRMCCS8                   $CHAR8.                             
      @582    I10_PRMCCS9                   $CHAR8.                             
      @590    I10_PRMCCS10                  $CHAR8.                             
      @598    I10_PRMCCS11                  $CHAR8.                             
      @606    I10_PRMCCS12                  $CHAR8.                             
      @614    I10_PRMCCS13                  $CHAR8.                             
      @622    I10_PRMCCS14                  $CHAR8.                             
      @630    I10_U_BLOOD                   N2PF.                               
      @632    I10_U_CATH                    N2PF.                               
      @634    I10_U_CTSCAN                  N2PF.                               
      @636    I10_U_EKG                     N2PF.                               
      @638    I10_U_MHSA                    N2PF.                               
      @640    I10_U_MRT                     N2PF.                               
      @642    I10_U_PACEMAKER               N2PF.                               
      @644    I10_U_PHYTHERAPY              N2PF.                               
      @646    I10_U_RADTHERAPY              N2PF.                               
      @648    I10_U_STRESS                  N2PF.                               
      @650    KEY                           15.                                 
      @665    U_CCU                         N2PF.                               
      @667    U_CHESTXRAY                   N2PF.                               
      @669    U_DIALYSIS                    N2PF.                               
      @671    U_ECHO                        N2PF.                               
      @673    U_ED                          N2PF.                               
      @675    U_EEG                         N2PF.                               
      @677    U_EPO                         N2PF.                               
      @679    U_ICU                         N2PF.                               
      @681    U_LITHOTRIPSY                 N2PF.                               
      @683    U_NEWBN2L                     N2PF.                               
      @685    U_NEWBN3L                     N2PF.                               
      @687    U_NEWBN4L                     N2PF.                               
      @689    U_NUCMED                      N2PF.                               
      @691    U_OBSERVATION                 N2PF.                               
      @693    U_OCCTHERAPY                  N2PF.                               
      @695    U_ORGANACQ                    N2PF.                               
      @697    U_OTHIMPLANTS                 N2PF.                               
      @699    U_RESPTHERAPY                 N2PF.                               
      @701    U_SPEECHTHERAPY               N2PF.                               
      @703    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
