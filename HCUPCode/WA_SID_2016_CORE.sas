...
*  Data Step                  *;                                                
*******************************;                                                
DATA WA_SIDC_2016_CORE;                                                         
INFILE 'WA_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 869;                           
...
INPUT                                                                           
      ...
      @282    I10_DX24                      $CHAR7.                             
      @289    I10_DX25                      $CHAR7.                             
      @296    I10_ECAUSE1                   $CHAR7.                             
      @303    I10_ECAUSE2                   $CHAR7.                             
      @310    I10_ECAUSE3                   $CHAR7.                             
      @317    I10_ECAUSE4                   $CHAR7.                             
      @324    I10_ECAUSE5                   $CHAR7.                             
      @331    I10_ECAUSE6                   $CHAR7.                             
      @338    I10_ECAUSE7                   $CHAR7.                             
      @345    I10_ECAUSE8                   $CHAR7.                             
      @352    I10_ECAUSE9                   $CHAR7.                             
      @359    I10_NDX                       N3PF.                               
      @362    I10_NECAUSE                   N2PF.                               
      @364    I10_NPR                       N3PF.                               
      @367    I10_PR1                       $CHAR7.                             
      @374    I10_PR2                       $CHAR7.                             
      @381    I10_PR3                       $CHAR7.                             
      ...
      @646    PL_UIC                        N2PF.                               
      @648    PL_UR_CAT4                    N2PF.                               
      @650    POA_Disch_Edit1               N2PF.                               
      @652    POA_Disch_Edit2               N2PF.                               
      @654    POA_Hosp_Edit1                N2PF.                               
      @656    POA_Hosp_Edit2                N2PF.                               
      @658    POA_Hosp_Edit3                N2PF.                               
      @660    POA_Hosp_Edit3_Value          N8P2F.                              
      @668    PointOfOrigin_X               $CHAR1.                             
      @669    PointOfOriginUB04             $CHAR1.                             
      @670    PRDAY1                        N5PF.                               
      @675    PRDAY2                        N5PF.                               
      @680    PRDAY3                        N5PF.                               
      @685    PRDAY4                        N5PF.                               
