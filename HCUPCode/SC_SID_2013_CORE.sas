...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2013_CORE;                                                         
INFILE 'SC_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 664;                           
...
INPUT                                                                           
      ...
      @614    PSTATE                        $CHAR2.                             
      @616    PSTCO                         N5PF.                               
      @621    PointOfOriginUB04             $CHAR1.                             
      @622    PointOfOrigin_X               $CHAR1.                             
      @623    RACE                          N2PF.                               
      @625    RACE_X                        $CHAR1.                             
      @626    TOTCHG                        N10PF.                              
      @636    TOTCHG_X                      N15P2F.                             
