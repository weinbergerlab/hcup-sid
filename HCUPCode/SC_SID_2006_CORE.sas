...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2006_CORE;                                                         
INFILE 'SC_SID_2006_CORE.ASC' FIRSTOBS=3 LRECL = 511;                           
...
INPUT                                                                           
      ...
      @304    PAY1                          N2PF.                               
      @306    PAY1_X                        $CHAR2.                             
      @308    PL_NHCS2006                   N2PF.                               
      @310    PL_RUCA10_2005                N2PF.                               
      @312    PL_RUCA4_2005                 N2PF.                               
      @314    PR1                           $CHAR7.                             
      @321    PR2                           $CHAR7.                             
      @328    PR3                           $CHAR7.                             
      @335    PR4                           $CHAR7.                             
