...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SIDC_2014_CORE;                                                         
INFILE 'FL_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1281;                          
...
INPUT                                                                           
      ...
      @484    HCUP_ED                       N2PF.                               
      @486    HCUP_OS                       N2PF.                               
      @488    HISPANIC_X                    $CHAR8.                             
      @496    HOSPBRTH                      N3PF.                               
      @499    HOSPST                        $CHAR2.                             
      @501    Homeless                      N2PF.                               
      @503    HospitalUnit                  N2PF.                               
      @505    KEY                           15.                                 
      @520    LOS                           N5PF.                               
      @525    LOS_X                         N6PF.                               
      @531    MDC                           N2PF.                               
      ...
      @593    PL_UIC                        N2PF.                               
      @595    PL_UR_CAT4                    N2PF.                               
      @597    POA_Disch_Edit1               N2PF.                               
      @599    POA_Disch_Edit2               N2PF.                               
      @601    POA_Hosp_Edit1                N2PF.                               
      @603    POA_Hosp_Edit2                N2PF.                               
      @605    POA_Hosp_Edit3                N2PF.                               
      @607    POA_Hosp_Edit3_Value          N8P2F.                              
      @615    PR1                           $CHAR7.                             
      @622    PR2                           $CHAR7.                             
      @629    PR3                           $CHAR7.                             
      @636    PR4                           $CHAR7.                             
      ...
      @1086   PSTATE                        $CHAR2.                             
      @1088   PSTCO2                        N5PF.                               
      @1093   PointOfOriginUB04             $CHAR1.                             
      @1094   PointOfOrigin_X               $CHAR2.                             
      @1096   RACE                          N2PF.                               
      @1098   RACE_X                        $CHAR1.                             
      @1099   SERVICELINE                   N2PF.                               
      @1101   TOTCHG                        N10PF.                              
      @1111   TOTCHG_X                      N15P2F.                             
      @1126   TRAN_IN                       N2PF.                               
      @1128   TRAN_OUT                      N2PF.                               
      @1130   VisitLink                     N9PF.                               
      @1139   YEAR                          N4PF.                               
