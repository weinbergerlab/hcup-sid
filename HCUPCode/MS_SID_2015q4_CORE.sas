...
*  Data Step                  *;                                                
*******************************;                                                
DATA MS_SIDC_2015q4_CORE;                                                       
INFILE 'MS_SID_2015q4_CORE.ASC' FIRSTOBS=3 LRECL = 1586;                        
...
INPUT                                                                           
      ...
      @133    HCUP_OS                       N2PF.                               
      @135    HISPANIC                      N2PF.                               
      @137    HISPANIC_X                    $CHAR1.                             
      @138    HospitalUnit                  N2PF.                               
      @140    HOSPST                        $CHAR2.                             
      @142    I10_DX_Admitting              $CHAR7.                             
      @149    I10_DX1                       $CHAR7.                             
      @156    I10_DX2                       $CHAR7.                             
      @163    I10_DX3                       $CHAR7.                             
      @170    I10_DX4                       $CHAR7.                             
      ...
      @677    I10_ECAUSE1                   $CHAR7.                             
      @684    I10_ECAUSE2                   $CHAR7.                             
      @691    I10_ECAUSE3                   $CHAR7.                             
      @698    I10_ECAUSE4                   $CHAR7.                             
      @705    I10_ECAUSE5                   $CHAR7.                             
      @712    I10_ECAUSE6                   $CHAR7.                             
      @719    I10_ECauseCCS1                N4PF.                               
      @723    I10_ECauseCCS2                N4PF.                               
      @727    I10_ECauseCCS3                N4PF.                               
      @731    I10_ECauseCCS4                N4PF.                               
      @735    I10_ECauseCCS5                N4PF.                               
      @739    I10_ECauseCCS6                N4PF.                               
      @743    I10_HOSPBRTH                  N3PF.                               
      @746    I10_NCHRONIC                  N3PF.                               
      @749    I10_NDX                       N3PF.                               
      @752    I10_NECAUSE                   N2PF.                               
      @754    I10_NEOMAT                    N2PF.                               
      @756    I10_NPR                       N3PF.                               
      @759    I10_ORPROC                    N2PF.                               
      @761    I10_PR1                       $CHAR7.                             
      ...
      @992    I10_PRCCS8                    N3PF.                               
      @995    I10_PRCCS9                    N3PF.                               
      @998    I10_PRCCS10                   N3PF.                               
      @1001   I10_PRCCS11                   N3PF.                               
      @1004   I10_PRCCS12                   N3PF.                               
      @1007   I10_PRCCS13                   N3PF.                               
      @1010   I10_PRCCS14                   N3PF.                               
      @1013   I10_PRCCS15                   N3PF.                               
      @1016   I10_PRCCS16                   N3PF.                               
      @1019   I10_PRCCS17                   N3PF.                               
      @1022   I10_PRCCS18                   N3PF.                               
      @1025   I10_PRCCS19                   N3PF.                               
      @1028   I10_PRCCS20                   N3PF.                               
      @1031   I10_PRCCS21                   N3PF.                               
      @1034   I10_PRCCS22                   N3PF.                               
      @1037   I10_PRCCS23                   N3PF.                               
      @1040   I10_PRCCS24                   N3PF.                               
      @1043   I10_PRCCS25                   N3PF.                               
      @1046   I10_PRCCS26                   N3PF.                               
      @1049   I10_PRCCS27                   N3PF.                               
      @1052   I10_PRCCS28                   N3PF.                               
      @1055   I10_PRCCS29                   N3PF.                               
      @1058   I10_PRCCS30                   N3PF.                               
      @1061   I10_PROCTYPE                  N3PF.                               
      @1064   I10_SERVICELINE               N2PF.                               
      @1066   KEY                           15.                                 
      @1081   LOS                           N5PF.                               
      @1086   LOS_X                         N6PF.                               
      @1092   MDC                           N2PF.                               
      ...
      @1155   PL_RUCC                       N2PF.                               
      @1157   PL_UIC                        N2PF.                               
      @1159   PL_UR_CAT4                    N2PF.                               
      @1161   POA_Disch_Edit1               N2PF.                               
      @1163   POA_Disch_Edit2               N2PF.                               
      @1165   POA_Hosp_Edit1                N2PF.                               
      @1167   POA_Hosp_Edit2                N2PF.                               
      @1169   POA_Hosp_Edit3                N2PF.                               
      @1171   POA_Hosp_Edit3_Value          N8P2F.                              
      @1179   PointOfOrigin_X               $CHAR1.                             
