...
*  Data Step                  *;                                                
*******************************;                                                
DATA WV_SIDC_2014_CORE;                                                         
INFILE 'WV_SID_2014_CORE.ASC' FIRSTOBS=3 LRECL = 578;                           
...
INPUT                                                                           
      ...
      @433    PL_NCHS                       N2PF.                               
      @435    PL_UR_CAT4                    N2PF.                               
      @437    POA_Disch_Edit1               N2PF.                               
      @439    POA_Disch_Edit2               N2PF.                               
      @441    POA_Hosp_Edit1                N2PF.                               
      @443    POA_Hosp_Edit2                N2PF.                               
      @445    POA_Hosp_Edit3                N2PF.                               
      @447    POA_Hosp_Edit3_Value          N8P2F.                              
      @455    PR1                           $CHAR7.                             
      @462    PR2                           $CHAR7.                             
      @469    PR3                           $CHAR7.                             
      @476    PR4                           $CHAR7.                             
      ...
      @518    PRVER                         N3PF.                               
      @521    PSTATE                        $CHAR2.                             
      @523    PointOfOriginUB04             $CHAR1.                             
      @524    PointOfOrigin_X               $CHAR1.                             
      @525    RACE                          N2PF.                               
      @527    RACE_X                        $CHAR10.                            
      @537    SERVICELINE                   N2PF.                               
      @539    TOTCHG                        N10PF.                              
      @549    TOTCHG_X                      N15P2F.                             
      @564    TRAN_IN                       N2PF.                               
      @566    TRAN_OUT                      N2PF.                               
      @568    YEAR                          N4PF.                               
      @572    ZIPINC_QRTL                   N3PF.                               
      @575    AYEAR                         N4PF.                               
      ;                                                                         
