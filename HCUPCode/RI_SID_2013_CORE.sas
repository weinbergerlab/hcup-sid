...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SIDC_2013_CORE;                                                         
INFILE 'RI_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1372;                          
...
INPUT                                                                           
      ...
      @1154   PSTCO                         N5PF.                               
      @1159   PSTCO2                        N5PF.                               
      @1164   PointOfOriginUB04             $CHAR1.                             
      @1165   PointOfOrigin_X               $CHAR1.                             
      @1166   RACE                          N2PF.                               
      @1168   RACE_X                        $CHAR8.                             
      @1176   TOTCHG                        N10PF.                              
      @1186   TOTCHG_X                      N15P2F.                             
      @1201   TRAN_IN                       N2PF.                               
      @1203   TRAN_OUT                      N2PF.                               
      @1205   YEAR                          N4PF.                               
