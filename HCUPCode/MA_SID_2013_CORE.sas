...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SIDC_2013_CORE;                                                         
INFILE 'MA_SID_2013_CORE.ASC' FIRSTOBS=3 LRECL = 851;                           
...
INPUT                                                                           
      ...
      @250    DXPOA14                       $CHAR1.                             
      @251    DXPOA15                       $CHAR1.                             
      @252    DaysBetweenVisits             N4PF.                               
      @256    DaysToEvent                   N6PF.                               
      @262    ECODE1                        $CHAR7.                             
      @269    ECODE2                        $CHAR7.                             
      @276    ECODE3                        $CHAR7.                             
      @283    ECODE4                        $CHAR7.                             
      ...
      @452    PAYER2_X                      $CHAR3.                             
      @455    PL_CBSA                       N3PF.                               
      @458    PL_RUCA10_2005                N2PF.                               
      @460    PL_RUCA2005                   N4P1F.                              
      @464    PL_RUCA4_2005                 N2PF.                               
      @466    PL_UR_CAT4                    N2PF.                               
      @468    PR1                           $CHAR7.                             
      @475    PR2                           $CHAR7.                             
      @482    PR3                           $CHAR7.                             
