...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SIDC_2016_CORE;                                                         
INFILE 'VT_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 2182;                          
...
INPUT                                                                           
      ...
      @1299   CPTM2_84                      $CHAR2.                             
      @1301   CPTM2_85                      $CHAR2.                             
      @1303   DaysToEvent                   N6PF.                               
      @1309   DIED                          N2PF.                               
      @1311   DISP_X                        $CHAR2.                             
      @1313   DISPUB04                      N2PF.                               
      @1315   DISPUNIFORM                   N2PF.                               
      @1317   DMONTH                        N2PF.                               
      @1319   DQTR                          N2PF.                               
      @1321   DRG                           N3PF.                               
      @1324   DRG_NoPOA                     N3PF.                               
      @1327   DRGVER                        N2PF.                               
      @1329   DSHOSPID                      $CHAR17.                            
      @1346   DXPOA1                        $CHAR1.                             
      @1347   DXPOA2                        $CHAR1.                             
      @1348   DXPOA3                        $CHAR1.                             
      @1349   DXPOA4                        $CHAR1.                             
      ...
      @1384   HCUP_OS                       N2PF.                               
      @1386   HISPANIC                      N2PF.                               
      @1388   HISPANIC_X                    $CHAR1.                             
      @1389   HOSP_NPI                      $CHAR10.                            
      @1399   HOSPST                        $CHAR2.                             
      @1401   I10_DX_Admitting              $CHAR7.                             
      @1408   I10_DX1                       $CHAR7.                             
      @1415   I10_DX2                       $CHAR7.                             
      @1422   I10_DX3                       $CHAR7.                             
      @1429   I10_DX4                       $CHAR7.                             
      ...
      @1534   I10_DX19                      $CHAR7.                             
      @1541   I10_DX20                      $CHAR7.                             
      @1548   I10_ECAUSE1                   $CHAR7.                             
      @1555   I10_ECAUSE2                   $CHAR7.                             
      @1562   I10_ECAUSE3                   $CHAR7.                             
      @1569   I10_ECAUSE4                   $CHAR7.                             
      @1576   I10_ECAUSE5                   $CHAR7.                             
      @1583   I10_ECAUSE6                   $CHAR7.                             
      @1590   I10_ECAUSE7                   $CHAR7.                             
      @1597   I10_ECAUSE8                   $CHAR7.                             
      @1604   I10_ECAUSE9                   $CHAR7.                             
      @1611   I10_ECAUSE10                  $CHAR7.                             
      @1618   I10_ECAUSE11                  $CHAR7.                             
      @1625   I10_NDX                       N3PF.                               
      @1628   I10_NECAUSE                   N2PF.                               
      @1630   I10_NPR                       N3PF.                               
      @1633   I10_PR1                       $CHAR7.                             
      @1640   I10_PR2                       $CHAR7.                             
      @1647   I10_PR3                       $CHAR7.                             
      ...
      @1850   PL_RUCC                       N2PF.                               
      @1852   PL_UIC                        N2PF.                               
      @1854   PL_UR_CAT4                    N2PF.                               
      @1856   POA_Disch_Edit1               N2PF.                               
      @1858   POA_Disch_Edit2               N2PF.                               
      @1860   POA_Hosp_Edit1                N2PF.                               
      @1862   POA_Hosp_Edit2                N2PF.                               
      @1864   POA_Hosp_Edit3                N2PF.                               
      @1866   POA_Hosp_Edit3_Value          N8P2F.                              
      @1874   PointOfOrigin_X               $CHAR1.                             
      @1875   PointOfOriginUB04             $CHAR1.                             
      @1876   PRDAY1                        N5PF.                               
      @1881   PRDAY2                        N5PF.                               
      @1886   PRDAY3                        N5PF.                               
      @1891   PRDAY4                        N5PF.                               
